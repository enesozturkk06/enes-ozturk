...
export default function WhatsAppButton({ message, fixed = true, label = "WhatsApp" }: Props) {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-13 h-13 bg-green-500 hover:bg-green-400 text-white rounded-full flex items-center justify-center shadow-[0_0_28px_rgba(34,197,94,0.4)] hover:shadow-[0_0_40px_rgba(34,197,94,0.6)] transition-shadow duration-300"
